...
Note that R Markdown (the file type of the exercise notebooks) extends this format to R code but is very similar in its basic function. On the other hand it isn't recognised by GitHub
