...
You can also access those conflicts with tidyverse_conflicts(). See which other packages are installed under the tidyverse umpbrella with 
tidyverse_packages()
...
# what about incresing the size of all the fonts?
