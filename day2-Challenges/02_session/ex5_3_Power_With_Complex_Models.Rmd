...
```{r}
model <- glmer(health_score ~ treatment + (1 | patient), data = data) 
...
model_with_more_participants <- extend(model, along = "patient", n = ___) 
...
Very detailed tutorial expanding on different situations, such as how we can improve power by changing the design and how to deal with interactions. This is essential reading:
