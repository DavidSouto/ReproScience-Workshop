...
group2 <- rnorm(n, mean, sd) t.test(group1, group2, var.equal = TRUE)$p.value } 

# Simulate 1000 experiments 
null_p_values <- replicate(1000, sim_null()) 

# Plot the distribution of p-values 
hist(null_p_values, breaks = 30, col = "skyblue", main = "Null Distribution of P-Values", xlab = "P-Value") abline(v = 0.05, col = "red", lwd = 2, lty = 2) 
...
group2 <- rnorm(n, mean2, sd) t.test(group1, group2, var.equal = TRUE)$p.value } 

# Simulate 1000 experiments 
alt_p_values <- replicate(1000, sim_alternative()) 

# Plot the distribution of p-values 
hist(alt_p_values, breaks = 30, col = "lightgreen", main = "Alternative Distribution of P-Values", xlab = "P-Value") abline(v = 0.05, col = "red", lwd = 2, lty = 2) 
...
calculate_power <- function(n, mean1 = 10, mean2 = 15, sd = 5, sims = 1000) { p_values <- replicate(sims, sim_alternative(n, mean1, mean2, sd)) mean(p_values < 0.05) } 
