...
To **commit** you require at least to provide a **summary** but not necessarily a description. The summary can be one word: e.g. *typos*. "commit to master". Now you have another option on GitHub Desktop (blue area). That is to **push to origin**. Now the remote repository is in synch with your local repository. 
